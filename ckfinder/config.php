...
//$config['licenseKey']  = 'N6C6ECNL11W6E2EQRYK641WK6B58G';
$config['licenseName'] = 'eduset.social';
$config['licenseKey']  = 'VEHELAA5MFKBKN9EF6G2YHNLHQFGW';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://eduset.social/postimage/userfiles/',// need to change the path
